      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Rules Section */}
            <div className="mt-8">
              <h3 className="font-semibold mb-4">Rules ({campaign.rules?.length || 0})</h3>
              
              {campaign.rules?.length > 0 ? (
                <div className="bg-white rounded-lg border border-gray-200 p-5">
                  <p className="text-sm text-gray-500">
                    Rules editor coming soon. For now, manage rules via API.
                  </p>
                </div>
              ) : (
                <div className="text-center py-8 bg-white rounded-lg border border-gray-200">
                  <p className="text-gray-500">No rules yet. Rules determine which variant to show based on signals (weather, time, location).</p>
                </div>
              )}
            </div>
          </div>
